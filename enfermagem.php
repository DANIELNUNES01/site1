...
<nav id="navbar" class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://maislaudo.com.br/wp-content/uploads/2025/01/o-que-faz-um-enfermeiro-e-outros-profissionais-de-enfermagem.jpeg" class="d-block w-100" alt="Curso de Edificações">
      <div class="carousel-caption d-md-block" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 100%; text-align: center; color: white; text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.7);">
        <h2 class="display-4">Enfermagem</h2>
